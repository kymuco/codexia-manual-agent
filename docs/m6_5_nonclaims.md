...
The supervisor is deliberately conservative around ambiguous effects: rare uncertainty may stall until exact reconciliation rather than risking duplicate external action.
