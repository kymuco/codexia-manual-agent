...
class ProcessPackProviderV2(BasePlugin):
    ...
    def codexia_workflow_implementation(
        ...
        implementation = StandaloneProcessWorkflowImplementationV2()
    ...
    def codexia_completion_criterion(
        ...
        criterion = StandaloneProcessCompletionCriterionV2()
        if criterion.binding.to_dict() != expected:
            raise RuntimeError(
                "Pack provider completion criterion drifted from distribution"
            )
        return criterion
